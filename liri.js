...
var concerts = this.spotify.concerts;
var movies = this.spotify.movies;
var spotSong = this.spotify.spotSong;

console.log(concerts, movies, spotSong);
  ...
  $.when(...tracks)
    .then((...tracks) => {
      tracks = tracks
        .map(getDataObject)
        .reduce((prev, curr) => [...prev, ...curr], []);
      const randomPlayList = getRandomTracks(30, tracks);
...
//Uncaught ReferenceError: $ is not defined at script2.js:89
$(app.init);
